...
class MRFNET(nn.Module, ABC):
    def __init__(self, channels):
        ...
        self.conv1_17 = nn.Conv2d(in_channels=features, out_channels=channels, kernel_size=kernel_size, padding=1,
                                  groups=groups, bias=False)
        self.conv1_18o = nn.Conv2d(in_channels=features, out_channels=channels, kernel_size=kernel_size, padding=1,
                                   groups=groups, bias=False)

        self.conv3 = nn.Conv2d(in_channels=channels*3, out_channels=channels, kernel_size=3, stride=1, padding=1,
                               groups=1, bias=True)
